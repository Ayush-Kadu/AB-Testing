...
curl -X OPTIONS "http://localhost:5008/api/auth/whatsapp/multi-tenant/waba-accounts" \
...
curl -X GET "http://localhost:5008/api/auth/whatsapp/multi-tenant/waba-accounts" \
