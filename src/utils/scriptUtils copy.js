...
const getMainScript = async (user) => {
    ...
    const script = `
        var userId = "${user._id}";
        //user consent for collecting data 
...
">
   <div>
            <strong style="font-size: 15px;">Your privacy matters</strong><br>
            We use cookies to improve your experience, analyze site traffic, and support marketing efforts. Click "Accept" to continue.
        </div>
        <div style="display: flex; justify-content: flex-end; gap: 10px;">
            <button id="declineCookiesBtn" style="
                padding: 8px 14px;
...
\`;
    ...
    document.getElementById("acceptCookiesBtn").addEventListener("click", () => {
        ...
        banner.remove();
    location.reload(); // Reload the page to initialize tracking
    });
    ...
    document.getElementById("declineCookiesBtn").addEventListener("click", () => {
        ...
        async function postUserDataToServer(userData) {
            ...
            const firebaseUrl = 'https://urlpt-api.onrender.com/api/visitors/add-visitors';
...
if (getCookie("cookie_consent") === "accepted") {
    ...
    if('${user.showCookieConsentBanner}'){
